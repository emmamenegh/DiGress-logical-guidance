...
class DiscreteDenoisingDiffusion(pl.LightningModule):
    ...
    def on_test_epoch_end(self) -> None:
        ...
        self.print("Saving the generated SMILES")
        self.save_samples(samples, target=None, file_path=os.path.join(os.getcwd(), f'unconditional_smiles.txt'))
        self.print("SMILES saved. Computing sampling metrics...")
    ...
    def save_samples(self, samples, target, file_path): # added
        
        cond_results = {'smiles': [], 'input_targets': target} # saves also invalid molecules
        invalid = 0
        num_components = []

        self.print("\tConverting generated molecules to SMILES ...")
        ...
        self.print(f"\tDone. Total samples: {len(samples)}")
        self.print(f"\tValid molecules (after relaxed validity): {len(samples) - invalid}")
        self.print(f"\tInvalid molecules: {invalid}")
