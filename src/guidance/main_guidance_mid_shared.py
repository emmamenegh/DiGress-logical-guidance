""" 
Supports guidance towards the satisfaction of the Lipinski rules with a mid-shared classifier architecture.
"""
import os
import sys
...
from src.guidance.guacamol_classifier_discrete_mid_shared import GuacamolClassifierDiscrete
...
def main(cfg: DictConfig):
    ...
    if cfg.general.trained_classifier_dir is not None and cfg.general.guidance_target is not None:
        model_path = os.path.join(cfg.general.trained_classifier_dir, 'mid_shared.ckpt')
