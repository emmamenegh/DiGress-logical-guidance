...
import src.datasets.guacamol_dataset_full_shared as guacamol_dataset # same
...
def main(cfg: DictConfig):
    ...
    dataset_infos.output_dims = {'X': 0, 'E': 0, 'y': 4} # binary classification with BCEWithLogitsLoss
