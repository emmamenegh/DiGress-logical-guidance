...
# to avoid circular dependency with guacamol_dataset.py
    ...
    def compute_relaxed_validity(self, generated):
        ...
        for graph in generated:
            ...
            if smiles is not None:
                ...
                valid.append(None)
        return valid, num_valid / len(generated)
...
def check_stability(atom_types, edge_types, dataset_info, debug=False,atom_decoder=None):
    ...
    for atom_type, atom_n_bond in zip(atom_types, n_bonds):
        ...
        if not is_stable and debug:
            print("Invalid bonds for atom %s with %d bonds" % (atom_decoder[atom_type], atom_n_bond))
